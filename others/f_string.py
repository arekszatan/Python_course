...
# wiadomości i raportów. Od wersji Pythona 3.6 dostępna jest wygodna metoda
# formatowania ciągów znaków znana jako f-string (formated string literals).
#
# Podstawy f-string
# Aby użyć f-string, wystarczy poprzedzić cią znaków literą f lub F przed
...
print(f'User: {person}, {person["name"], person["age"]}')
